...
#include "device_libs/platform_hm2051.h"
...
//ASUS_BSP--- 
	...
	{"mrfld_wm8958", SFI_DEV_TYPE_IPC, 1, &merfld_wm8958_audio_platform_data,
						&ipc_device_handler},
	{"mrfld_rt5648", SFI_DEV_TYPE_IPC, 1, &merfld_rt5648_audio_platform_data,
						&ipc_device_handler},
	...
	{"rt5648", SFI_DEV_TYPE_I2C, 0, &no_platform_data, NULL},
#ifdef CONFIG_HSI
...
#ifdef CONFIG_Z580C
struct devs_id __initconst device_ids_z580c[] = {
	/* UART devices */
	{"bcm4752", SFI_DEV_TYPE_UART, 0, &intel_mid_gps_device_init, NULL},
	{"bcm47521", SFI_DEV_TYPE_UART, 0, &intel_mid_gps_device_init, NULL},
	{"bcm47531", SFI_DEV_TYPE_UART, 0, &intel_mid_gps_device_init, NULL},
...
//ASUS_BSP+++
	...
	{"ov5670", SFI_DEV_TYPE_I2C, 0, &ov5670_platform_data,
					&intel_register_i2c_camera_device},
	{"hm2051", SFI_DEV_TYPE_I2C, 0, &hm2051_platform_data,
					&intel_register_i2c_camera_device},
//ASUS_BSP---
	{"gc2235", SFI_DEV_TYPE_I2C, 0, &gc2235_platform_data,
					&intel_register_i2c_camera_device},
	...
	{"rt5671", SFI_DEV_TYPE_I2C, 1, &no_platform_data, NULL},
	{"rt5648", SFI_DEV_TYPE_I2C, 0, &no_platform_data, NULL},
	{"adc081c", SFI_DEV_TYPE_I2C, 0, &no_platform_data, NULL},
#ifdef CONFIG_HSI
	{"hsi_ifx_modem", SFI_DEV_TYPE_HSI, 0, &hsi_modem_platform_data, NULL},
	{"hsi_ffl_modem", SFI_DEV_TYPE_HSI, 0, &ffl_modem_platform_data, NULL},
	{"hsi_edlp_modem", SFI_DEV_TYPE_HSI, 0, &edlp_modem_platform_data,
...
struct devs_id __initconst device_ids_fe171mg[] = {
        /* UART devices */
        {"bcm4752", SFI_DEV_TYPE_UART, 0, &intel_mid_gps_device_init, NULL},
        {"bcm47521", SFI_DEV_TYPE_UART, 0, &intel_mid_gps_device_init, NULL},
        {"bcm47531", SFI_DEV_TYPE_UART, 0, &intel_mid_gps_device_init, NULL},
...
#ifdef CONFIG_Z580C
        return device_ids_z580c;
#endif

#ifdef CONFIG_FE171MG
        return device_ids_fe171mg;
#endif
}
