...
#ifdef CHIPNUM
extern void dhd_get_customized_country_code(struct net_device *dev, char *country_iso_code, wl_country_t *cspec,uint chipnum);
#else
...
#ifdef CHIPNUM
extern uint dhd_get_chipnum(struct net_device *dev);
#endif
