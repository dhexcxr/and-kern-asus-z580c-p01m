...
#if !defined(SDIO_DEVICE_ID_BROADCOM_4343s)
#define SDIO_DEVICE_ID_BROADCOM_4343s    0xa9a6
#endif /* !defined(SDIO_DEVICE_ID_BROADCOM_4343s) */
...
//CY+ clear MMC_PM_KEEP_POWER before enable power for fix interface up fail
			if(sdio_func->card->host->pm_flags & MMC_PM_KEEP_POWER){
				pr_err("wifi_on handle host keep power corruption\n");
				sdio_func->card->host->pm_flags &= ~MMC_PM_KEEP_POWER;
			}
//CY-
...
static const struct sdio_device_id bcmsdh_sdmmc_ids[] = {
	...
	{ SDIO_DEVICE(SDIO_VENDOR_ID_BROADCOM, SDIO_DEVICE_ID_BROADCOM_4343s) },*/
