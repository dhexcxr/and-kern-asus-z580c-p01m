...
//CY+ scan every 300s and set 30s wakelock if there is at least one rembered AP
#define ASUS_PNO 1
//CY-
...
//CY+
#ifdef ASUS_PNO
				DHD_ERROR(("%s: set pno_freq_expo_max = 0\n", __FUNCTION__));
				pno_freq_expo_max = 0;
#else
